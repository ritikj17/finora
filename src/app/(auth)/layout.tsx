...
export const metadata = {
  title: "Authentication | FinPilot AI",
  description: "Sign in or create an account to access your financial dashboard.",
};
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <div className="relative z-20 flex items-center text-lg font-medium">
          <Link href="/" className="flex items-center gap-2 group transition-opacity hover:opacity-80">
            ...
            <span className="font-semibold text-xl tracking-tight text-zinc-100">
              FinPilot <span className="text-zinc-400">AI</span>
            </span>
          </Link>
        </div>
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;FinPilot AI completely transformed how we manage our startup's runway. The automated categorization and predictive modeling saved us hundreds of hours.&rdquo;
            </p>
            <footer className="text-sm text-zinc-400">Sofia Davis, Founder at Vertex</footer>
          </blockquote>
        </div>
      </div>
